...
def cmd_start(message: types.Message):
    ...
    bot.send_message(
        message.chat.id,
        "👜 Добро пожаловать в AngelBags!\n"
        "Интернет-магазин доступных брендов 👜 👠\n\n"
        "Брендовые сумки, клатчи, рюкзаки и аксессуары — каталог, наличие и статус заказа всегда под рукой.\n\n"
